...
export default function StudentDashboard() {
  ...
  const { student, room, fees, attendance } = data;
  const s = student || {};

  return (
    <div>
      <h2 className="text-xl font-semibold text-slate-800 mb-4">Student Dashboard</h2>
      <p className="text-slate-600 mb-6">Your profile, room, fees, and attendance.</p>
